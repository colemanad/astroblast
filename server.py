            ...
            if self.assert_msg_content_size(msg_type, msg_content, 1):
                ...
                if self.assert_msg_content_type(msg_type, id_content[0], MSGCONTENT.ID):
                    if id_content[1] == int(GAME.INVALID_ID.value):
                        ...
                        self.log("Client with ID %d already exists, rejecting connection request" % (id_content[1]))
